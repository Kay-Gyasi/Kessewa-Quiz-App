        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "varchar(20)", nullable: true),
                    Type = table.Column<string>(type: "varchar(15)", nullable: false),
                    Email_EmailAddress = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Phone_PhoneNumber = table.Column<string>(type: "varchar(20)", nullable: true),
                    Address_Street = table.Column<string>(type: "varchar(100)", nullable: true),
                    Address_ZipCode = table.Column<string>(type: "varchar(40)", nullable: true),
                    Address_City = table.Column<string>(type: "varchar(30)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lecturers_Departments_DepartmentsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(50)", nullable: false),
                    CreditHours = table.Column<string>(type: "varchar(15)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Question_QuestionText = table.Column<string>(type: "varchar(200)", nullable: true),
                    Question_Answer = table.Column<string>(type: "varchar(150)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Answer = table.Column<string>(type: "nvarchar(150)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lecturers_DepartmentsId",
                table: "Lecturers",
                column: "DepartmentsId");
